...
(use-package ido
  ...
  (setq ido-file-extensions-order
		'(".org" ".ml" ".rkt" ".py" ".java" ".txt" ".emacs" ".php" ".js" ".html" ".tex" ".scrbl"))
  (setq ido-create-new-buffer 'always
